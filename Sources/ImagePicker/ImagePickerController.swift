...
open class ImagePickerController: UIViewController {
  ...
  @objc func adjustButtonTitle(_ notification: Notification) {
      ...
      bottomContainer.doneButton.setTitle(configuration.doneButtonTitle, for: UIControl.State())
  }
  ...
  fileprivate func takePicture() {
    print("galleryView.selectedStack.assets.count",galleryView.selectedStack.assets.count)
    print("isBelowImageLimit",isBelowImageLimit)
